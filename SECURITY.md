...
3. **No PII beyond work email + role**, no compensation, health, or personal data — see the hard prohibitions in [`guides/DATA-ORGANIZATION-PLAYBOOK.md`](./guides/DATA-ORGANIZATION-PLAYBOOK.md).
...
4. Write a `memory/learnings.md` entry (type `pitfall`) so it doesn't recur.
