...
- A rule that must hold 100% of the time belongs here (deterministic), with the prose version in `AGENTS.md` as explanation only — see `docs/ARCHITECTURE.md` principle 12.
